= Java 8 to Java 15 - Some Notable Enhancements

== Title
Notable feature changes since Java 8 until Java 15
...
Similar constraints apply for Java 10, 11, 12, 13, 14 and 15. However, post-Java 9, the release cadence of 6 months has greatly reduced the number of features delivered making the content more viable to present a larger percentage of changes.
